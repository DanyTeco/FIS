...
array_push($assets1, array('script', 'js/jquery-2.1.4.min.js'));
...
elseif(isset($_GET['reg']) && $_GET['reg']==1)
{
	...
	elseif(isset($_GET['view']) && $_GET['view']==1)
	{
		...
		array_push($assets1, array('css', 'css/dataTables.tableTools.css'));
		array_push($assets1, array('script', 'js/jquery.dataTables.min.js'));
		array_push($assets1, array('script', 'js/dataTables.tableTools.js'));
	...
	elseif(isset($_GET['prog']) && $_GET['prog']==1)
	{
		...
		array_push($assets1, array('css', 'css/jquery.dataTables.min.css'));
		array_push($assets1, array('css', 'css/jquery.dataTables_themeroller.css'));
		array_push($assets1, array('css', 'css/jquery-ui.css'));
		array_push($assets1, array('script', 'js/jquery.dataTables.min.js'));
		array_push($assets1, array('script', 'js/jquery-ui.min.js'));
...
elseif(isset($_GET['admin']) && $_GET['admin']==1)
{
	...
	{
		array_push($assets1, array('css', 'css/main.css'));
		array_push($files, 'header.php', 'left.php', 'before-c.php', 'top.php', 'admin_users.php', 'after-c.php',  'footer.php');
		load_template($files, $assets1, $assets2);
	}
	if(isset($_GET['users_log']) && $_GET['users_log']==1)
	{
		array_push($assets1, array('css', 'css/jquery.dataTables.min.css'));
		array_push($assets1, array('css', 'css/jquery.dataTables_themeroller.css'));
		array_push($assets1, array('script', 'js/jquery.dataTables.min.js'));
		array_push($assets1, array('script', 'js/admin_users_log.js'));
		array_push($assets1, array('css', 'css/main.css'));
		array_push($files, 'header.php', 'left.php', 'before-c.php', 'top.php', 'admin_users_log.php', 'after-c.php',  'footer.php');
		load_template($files, $assets1, $assets2);
	}
	...
	elseif(isset($_GET['del_user']) && is_numeric($_GET['del_user']))
	{
		delete_user();	
	}
	else
	{
		array_push($assets1, array('css', 'css/main.css'));
		array_push($files, 'header.php', 'left.php', 'before-c.php', 'top.php', 'admin_fp.php', 'after-c.php',  'footer.php');
		load_template($files, $assets1, $assets2);
	}
