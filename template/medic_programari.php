<div class="page medic_prog">
    ...
    <table id="medic_myprog_table" cellspacing="0" class="cell-border stripe hover">
            <thead>
                <tr>
                    <th>Nume</th>
                    <th>Prenume</th>
    ...
    <div class="title">Adauga o programare noua</div>
     ...
     <div class="content">
     <form method="post" action="./?medic=1&medic_new_prog=1">
        <table id="medic_new_prog_table" cellspacing="0" class="cell-border stripe hover">
            <thead>
                <tr>
                	<th>Select</th>
                    <th>Nume</th>
