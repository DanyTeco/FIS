<div class="page reg_prog">

	<div class="title">Programari</div>
    
    
    <div class="content">
        <table id="reg_prog_table" cellspacing="0" class="cell-border stripe hover">
            <thead>
                <tr>
                    <th>Nume</th>
                    <th>Prenume</th>
    ...
    <div class="title">Adauga programare noua</div>
    
     <div class="content">
     <form method="post" action="./?reg=1&do_new_prog=1">
        <table id="reg_new_prog_table" cellspacing="0" class="cell-border stripe hover">
            <thead>
                <tr>
                	<th>Select</th>
                    <th>Nume</th>
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select name="pers" class="form-control">
            ...
            <?php
				global $db;
				$result=$db->prepare("SELECT * FROM user WHERE type=? OR type=?");
				$result->execute(array('medic', 'laborant'));
